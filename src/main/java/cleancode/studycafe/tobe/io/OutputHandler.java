...
public class OutputHandler {
    ...
    public void showPassOrderSummary(StudyCafePassOder passOder) {
        StudyCafeSeatPass selectedPass = passOder.getSeatPass();
        Optional<StudyCafeLockerPass> optionalLockerPass = passOder.getLockerPass();
        ...
        int discountPrice = passOder.getDiscountPrice();
        if (discountPrice > 0) {
            System.out.println("이벤트 할인 금액: " + discountPrice + "원");
        }

        int totalPrice = passOder.getTotalPrice();
